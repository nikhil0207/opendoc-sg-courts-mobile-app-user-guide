...
const BASEURL = 'opendoc-sg-courts-mobile-app-user-guide'.replace('/', '')
...
const S3_PDF_FOLDER = 'opendocsg/opendoc-sg-courts-mobile-app-user-guide'.replace(/\//g, '-') + (IS_PROD ? '' : '-staging')
