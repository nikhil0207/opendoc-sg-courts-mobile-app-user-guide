(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-sg-courts-mobile-app-user-guide'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-sg-courts-mobile-app-user-guide/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "SG Courts Mobile App User Guide"
